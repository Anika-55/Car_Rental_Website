...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            <Title title='Whats Our Customers Say' subTitle='Discover why discerning travelers choose stayVenture for their luxury accommodations around the world.'></Title>
